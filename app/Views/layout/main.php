...
use App\Controllers\Konfigurasi;
...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="topbar-left">
                <a href="/" class="logo">
                    <span class="logo-light">
                        <?= $konfigurasi['nama_web'] ?> </span>
                    <span class="logo-sm">
                        <img src="<?= base_url('img/konfigurasi/icon/' . $konfigurasi['icon']) ?>" alt="" height="35" class="rounded-circle">
                    </span>
                </a>
            </div>
        ...
        <div class="content-page">
            ...
            <footer class="footer">
                © 2023 <span class="d-none d-sm-inline-block"> <?= $konfigurasi['nama_web'] ?></i></span>
            </footer>
