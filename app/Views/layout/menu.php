...
<?php if (session()->get('level') == 2) { ?>
    ...
    <li>
        <a href="<?= base_url('auth/staf') ?>" class="waves-effect">
            <i class="mdi mdi-account-star-outline"></i> <span> Tenaga Kependidikan </span>
        </a>
    </li>
    <li>
...
<li class="menu-title">Ekstrakurikuler</li>
<li>
    <a href="<?= base_url('auth/ekstrakurikuler') ?>" class="waves-effect">
        <i class="mdi mdi-run-fast"></i> <span> Ekstrakurikuler </span>
    </a>
</li>
