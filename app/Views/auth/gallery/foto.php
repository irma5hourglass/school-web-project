...
<div class="modal fade" id="modalfoto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <?= form_open_multipart('gallery/uploadfoto', ['class' => 'formfoto']) ?>
            <?= csrf_field(); ?>
                ...
                <div class="row">
                    <?php foreach ($foto as $foto_item) { ?>
                        <div class="col-lg-3 col-md-4 col-sm-6 mb-2">
                            <div class="card">
                                <img class="img-thumbnail" src="<?= base_url('img/foto/thumb/thumb_' . $foto_item['nama_foto']) ?>" alt="Foto">
                                <div class="card-body text-center">
                                    <h6 class="text-center"><?= esc($foto_item['ket_foto']) ?></h6>
                                    <a href="javascript:void(0)" id="hapusfoto" onclick="hapusfoto(<?= $foto_item['foto_id'] ?>)" class="btn btn-sm btn-danger"><i class="fa fa-trash-alt"></i></a>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
