...
<div class="row">
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-heading p-4">
                    ...
                    <div>
                        <h5 class="font-16">Tenaga Kependidikan</h5>
                    </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="card">
            <div class="card-heading p-4">
                <div class="mini-stat-icon float-right">
                    <i class="mdi mdi-run-fast bg-ekstra text-white"></i>
                </div>
                <div>
                    <h5 class="font-16">Ekstrakurikuler</h5>
                </div>
                <h3 class="mt-4"><?= $ekstrakurikuler['ekstra_id'] ?></h3>
            </div>
        </div>
    </div>
</div>
